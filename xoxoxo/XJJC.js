...
async function joinLeaderTuan() {
  $.tuanIdS = null;
  if (!$.tuanIdS) await updateTuanIdsCDN('https://github.com/love-pig-pig/Daily-tasks/raw/main/jd_updateFactoryTuanId.json');
...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: "https://github.com/love-pig-pig/Daily-tasks/raw/main/JD_Dream_Factory.json",headers:{
      "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
    }}, async (err, resp, data) => {
      try {
        if (err) {
...
function requireConfig() {
  return new Promise(async resolve => {
    await updateTuanIdsCDN('https://github.com/love-pig-pig/Daily-tasks/raw/main/jd_updateFactoryTuanId.json');
