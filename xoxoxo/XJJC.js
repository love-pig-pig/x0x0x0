...
let tuanActiveId = `X_krqiP9DEYU9WDbxISV6Q==`;
...
async function joinLeaderTuan() {
  $.tuanIdS = null;
  if (!$.tuanIdS) await updateTuanIdsCDN('https://raw.githubusercontent.com/love-pig-pig/Daily-tasks/main/jd_updateFactoryTuanId.json');
...
function updateTuanIds(url = 'https://raw.githubusercontent.com/love-pig-pig/Daily-tasks/main/jd_updateFactoryTuanId.json') {
  return new Promise(resolve => {
